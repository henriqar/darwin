...
from darwin.engine.execution.clustering import clustering

from darwin.engine.opt import agtfactory as agf
from darwin.engine.opt import spfactory as spf

class ga(mediator, clustering):

    def __init__(self, kwargs):

        super(mediator).__init__(kwargs)
    ...
    def execute(self, m, n, func, names, sets, max_itr):
        ...
        opt_searchspace = spf.create_searchspace('ga', m, n, self._kwargs)
